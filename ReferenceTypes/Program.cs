...
namespace ReferenceTypes
{
    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            sayılar2[0] = 1000; //Sayılar 2'nin 0. elemanını 1000 yaparsak iki dizi de RAM'de birbirine aynı adres üzerinden bağlı oldukları için Sayılar 1 dizisinin 0. elemanı da 1000 olacaktır.

            Console.WriteLine("Sayılar1[0]: " + sayılar1[0]); //Çıktı: 1000
            ...
            Console.WriteLine(person2.FirstName); //Person 2'nin de son halini Cihat olarak yazdırır.
    ...
    internal class Person //Base Class - Ana Sınıf
    {
    ...
    internal class Customer : Person //Customer bir Person'dur.
    {
        public string CreditCardNumber { get; set; }
    }

    internal class Employee : Person //Employee bir Person'dur
    {
